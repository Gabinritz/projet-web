...
<div class="container" style="text-align: center; margin-top: 2rem;">
        @if ($activity->participates) {{-- [DONNEES DANS IDEES] --}}
            ...
            <div class="card__content-bot" style="display: flex; justify-content : space-around;">
                <button class="btn accept__btn" id="btnAccept-1" onclick="accept()">Télécharger la liste au format CSV</button>
                <button class="btn accept__btn" id="btnAccept-1" onclick="accept()">Télécharger la liste au format PDF</button>
            </div>
